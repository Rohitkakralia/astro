      ...
      >
        ...
        <thead>
          <tr style={{ background: "#e5e7eb" }}>
            <th style={th}>A<br /><span style={thSub}>Planets</span></th>
            <th style={th}>B<br /><span style={thSub}>Hit From</span></th>
...
<td style={td}>
  {planet ? (
    <>
      ...
      {degFormatted ? <span style={{ color: "#13100a", fontFamily: "monospace", fontSize: "1.2em" }}> {degFormatted}</span> : ""}
      {planet.traits
